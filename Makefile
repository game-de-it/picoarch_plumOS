...
CFLAGS     += -I./ -I./libretro-common/include/ -I$(SYSROOT)/usr/include/SDL -DCONTENT_DIR='"/storage/roms"'

LDFLAGS    = -L$(SYSROOT)/usr/lib -lc -ldl -lgcc -lm -lSDL -lasound -lpng -lz -Wl,--gc-sections -flto
